...
def plotter():
    ...
    # log_dir = "/global/research/students/sapelt/Masters/MasterThesis/logshp/PF00210"
    # reader = SummaryReader(log_dir, extra_columns={"dir_name"} )
    # df = reader.tensors
    # import pandas as pd
    ...
    # plt.tight_layout()
    # plt.savefig('/home/sapelt/Documents/Master/FINAL/One-Hot PF00210 Model Training Results.png', dpi=600)
...
##############################################################################################
    ...
    # ax6.set_title('Full Model (D 24380) - Evaluation Results')
    # ax6.set_xticks(range(len(eval_labels)))
    # ax6.set_xticklabels(eval_labels)
