...
if __name__ == "__main__":
    ...
    fasta = DomainProcessing(
        "/global/research/students/sapelt/Masters/rawPF00217.fasta"
    )
    seqarray_clean5, boundaries_allPF00217 = fasta.distribution_finder(
        fasta.len_finder()
    )
    dimension_positive5 = fasta.dimension_finder(fasta.len_finder())
    ...
    fasta = DomainProcessing(
        "/global/research/students/sapelt/Masters/rawPF00303.fasta"
    )
    seqarray_clean7, boundaries_allPF00303 = fasta.distribution_finder(
        fasta.len_finder()
    )
    dimension_positive7 = fasta.dimension_finder(fasta.len_finder())
    print("targeted dimension", dimension_positive7)

    # 8th positive Domain PF00246
    print("Loading positive domain PF00246")
    fasta = DomainProcessing(
        "/global/research/students/sapelt/Masters/rawPF00246.fasta"
    )
    seqarray_clean8, boundaries_allPF00246 = fasta.distribution_finder(
        fasta.len_finder()
    )
    ...
    fasta = DomainProcessing(
        "/global/research/students/sapelt/Masters/rawPF00457.fasta"
    )
    seqarray_clean9, boundaries_allPF00457 = fasta.distribution_finder(
        fasta.len_finder()
    )
    ...
    fasta = DomainProcessing(
        "/global/research/students/sapelt/Masters/rawPF00502.fasta"
    )
    seqarray_clean10, boundaries_allPF00502 = fasta.distribution_finder(
        fasta.len_finder()
    )
    ...
    boundaries_all = [
        ...
        boundaries_allPF00211,
        boundaries_allPF00215,
        boundaries_allPF00217,
        boundaries_allPF00406,
        boundaries_allPF00303,
        boundaries_allPF00246,
        boundaries_allPF00457,
        boundaries_allPF00502,
